...
android {
    ...
    defaultConfig {
        ...
        val apkPrefixLabels = listOf("gesturebitmap", libraryVersion, buildNumber)
...
sonar {
    properties {
        ...
        property("sonar.projectKey", "albertoirurueta_irurueta-android-gesture-bitmap-view")
        property("sonar.projectName", "irurueta-android-gesture-bitmap-view")
...
mavenPublishing {
    ...
    pom {
        name.set("irurueta-android-gesture-bitmap-view")
        description.set("A touch gesture capable Android view to display bitmaps and perform scaling, translation and rotation on the bitmap")
        inceptionYear.set("2025")
        url.set("https://github.com/albertoirurueta/irurueta-android-gesture-bitmap-view/")
        licenses {
            license {
                name.set("Apache License 2.0")
                url.set("https://github.com/albertoirurueta/irurueta-android-gesture-bitmap-view/blob/main/LICENSE")
                distribution.set("https://github.com/albertoirurueta/irurueta-android-gesture-bitmap-view/blob/main/LICENSE")
            }
        }
        developers {
            developer {
        ...
        scm {
            url.set("https://github.com/albertoirurueta/irurueta-android-gesture-bitmap-view/")
            connection.set("scm:git:github.com/albertoirurueta/irurueta-android-gesture-bitmap-view.git")
            developerConnection.set("scm:git:ssh://github.com/albertoirurueta/irurueta-android-gesture-bitmap-view.git")
        }
    }
}
