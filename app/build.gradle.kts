...
android {
    namespace = "com.irurueta.android.gesturebitmap.app"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.irurueta.android.gesturebitmap.app"
        minSdk = 24
        targetSdk = 36
        versionCode = 2
        versionName = "1.1.0"
...
sonar {
    properties {
        ...
        property("sonar.projectName", "irurueta-android-gesture-bitmap-view-${project.name}")
